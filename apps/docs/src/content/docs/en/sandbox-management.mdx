...
Sandboxes are isolated development environments managed by Daytona. This guide covers how to create, manage, and remove Sandboxes using the SDK (Python, TypeScript, and Ruby).
...
The `language` parameter controls which programming language runtime is available for direct code execution inside the Sandbox.

- **`python`** – Python runtime (default in both the Python SDK and TypeScript SDK when `language` is not specified).
- **`typescript`** – TypeScript runtime.
- **`javascript`** – JavaScript runtime.

If `language` is omitted, the SDK will default to `python`. You can always override this by explicitly setting the `language` value when creating the Sandbox.

### Basic Sandbox Creation

The Daytona SDK provides methods to create Sandboxes with default configurations, specific languages, custom names, or custom labels using Python, TypeScript, and Ruby.
...
<Tabs syncKey="language">
  ...
  <TabItem label="Ruby" icon="seti:ruby">
    ...
    # Create a Sandbox with custom labels
    params = Daytona::CreateSandboxFromSnapshotParams.new(labels: { 'SOME_LABEL' => 'my-label' })
    sandbox = daytona.create(params)
    ```
...
See: [create (Python SDK)](/docs/en/python-sdk/sync/daytona#daytonacreate), [create (TypeScript SDK)](/docs/en/typescript-sdk/daytona#create), [create (Ruby SDK)](/docs/en/ruby-sdk/daytona#create)
...
The Daytona SDK provides methods to get information about a Sandbox, such as ID, root directory, and status using Python, TypeScript, and Ruby.
...
The Daytona SDK provides methods to stop and start Sandboxes using Python, TypeScript, and Ruby.
...
The Daytona SDK provides methods to archive Sandboxes using Python, TypeScript, and Ruby.
...
See: [archive (Python SDK)](/docs/python-sdk/sync/sandbox#sandboxarchive), [archive (TypeScript SDK)](/docs/typescript-sdk/sandbox#archive), [archive (Ruby SDK)](/docs/ruby-sdk/sandbox#archive)

## Delete Sandbox

The Daytona SDK provides methods to delete Sandboxes using Python, TypeScript, and Ruby.
...
See: [delete (Python SDK)](/docs/python-sdk/sync/sandbox#sandboxdelete), [delete (TypeScript SDK)](/docs/typescript-sdk/sandbox#delete), [delete (Ruby SDK)](/docs/ruby-sdk/sandbox#delete)
