...
The Daytona SDK provides official [Python](/docs/en/python-sdk), [TypeScript](/docs/en/typescript-sdk), and [Ruby](/docs/en/ruby-sdk) interfaces for interacting with Daytona, enabling you to programmatically manage development environments and execute code. [Python SDK](/docs/en/python-sdk) supports both sync and async programming models where async classes are prefixed with `Async`.
...
Daytona provides official Python, TypeScript, and Ruby SDKs for interacting with the Daytona platform. Install the SDK using your preferred method:
...
Use the Daytona SDK [Python examples](https://github.com/daytonaio/daytona/tree/main/examples/python), [TypeScript/JavaScript examples](https://github.com/daytonaio/daytona/tree/main/examples/typescript), or [Ruby examples](https://github.com/daytonaio/daytona/tree/main/examples/ruby) to create a Sandbox and run your code.
